...
import { MemoryEntity, ResourceEntity, SkillEntity } from '../database/entities';
      ...
      return {
        ...
        imports: [
          TypeOrmModule.forRoot({
            ...
            entities: [MemoryEntity, ResourceEntity, SkillEntity],
            synchronize: false,
            logging: process.env.DB_LOGGING === 'true',
          }),
          TypeOrmModule.forFeature([MemoryEntity, ResourceEntity, SkillEntity]),
        ],
        providers: [
          {
